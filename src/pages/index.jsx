    ...
    <Parallax pages={5}>
      ...
      <Content speed={0.4} offset={3}>
        <Inner>
          ...
          <AboutHero>
            ...
            <AboutSub>
              Senior Software Engineer / CTO, Unicorn Mark
            </AboutSub>
          </AboutHero>
          <AboutDesc>
            I am a dedicated, enthusiastic leader, a creative solution-maker and a web engineering expert with more than 3 years of experience. I am a skilled full-stack developer. I am passionate about building apps with React Native, React.js, Objective-C, and Node.js.
          </AboutDesc>
        </Inner>
      </Content>
      ...
      <Content speed={0.4} offset={4}>
        <Inner>
          ...
          <ContactText>
            Say <a href="mailto:ankit.c1010@gmail.com">Hi</a> or find me on other platforms:{' '}
            <a href="https://dribbble.com/LekoArts">Github</a> &{' '}
          </ContactText>
        </Inner>
        <Footer>
          &copy; 2018 by Unicorn Mark.{' '}
        </Footer>
      </Content>
